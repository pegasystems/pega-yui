...
(function () {
    ...
    */
    ...
    pega.extend(pega.widget.Button, pega.util.Element, {
        ...
        _setMenu: function (p_oMenu) {
            ...
            var bLazyLoad = this.get("lazyloadmenu"),
                ...
                /*
                    ...
                    of pega.widget.Menu or pega.widget.Overlay.
                */
                ...
                if (oMenu) {
                    ...
                    if (Menu && oMenu instanceof Menu) {
                        ...
                        if (!m_oOverlayManager) {
                            ...
                            m_oOverlayManager = 
                                new pega.widget.OverlayManager();
        ...
        */
        _addListenersToForm: function () {
            ...
            var oForm = this.getForm(),
                onFormKeyPress = pega.widget.Button.onFormKeyPress,
        ...
        * @protected
        * @param {Event} p_oEvent Object representing the DOM event object 
        * passed back by the event utility (pega.util.Event) that triggered 
        * the display of the menu.
        */
        _showMenu: function (p_oEvent) {

            if (pega.widget.MenuManager) {

                pega.widget.MenuManager.hideVisible();
        ...
        */
		...
		if(pega.u.d.fieldValuesList.get("MENUBUTTON_DEFAULT_TITLE") && pega.u.d.fieldValuesList.get("MENUBUTTON_MENU_VISIBLE_TITLE") )
	       
	       sTitle = this._menu.cfg.getProperty("visible") ? 
                                pega.u.d.fieldValuesList.get("MENUBUTTON_MENU_VISIBLE_TITLE"): 
                                pega.u.d.fieldValuesList.get("MENUBUTTON_DEFAULT_TITLE") ;
        ...
        * object passed back by the event utility (pega.util.Event).
        */
        ...
        * <a href="pega.widget.Overlay.html">pega.widget.Overlay</a> instance 
        ...
        */
		...
		if(pega.u.d.fieldValuesList.get("MENUBUTTON_MENU_VISIBLE_TITLE") ) {
		       
                sTitle = pega.u.d.fieldValuesList.get("MENUBUTTON_MENU_VISIBLE_TITLE");
    		}
        ...
        * @param {Array} p_aArgs Array of arguments sent when the event
        * was fired.
        * @param {<a href="pega.widget.MenuItem.html">
        * pega.widget.MenuItem</a>} p_oItem Object representing the menu 
        ...
        */
        init: function (p_oElement, p_oAttributes) {
            ...
            pega.widget.Button.superclass.init.call(this, p_oElement, 
                p_oAttributes);
        ...
        */
        initAttributes: function (p_oAttributes) {
            ...
            pega.widget.Button.superclass.initAttributes.call(this, 
                oAttributes);
            ...
            * <ul>
            * <li>Object specifying a <a href="pega.widget.Menu.html">
            * pega.widget.Menu</a> instance.</li>
            * <li>Object specifying a <a href="pega.widget.Overlay.html">
            * pega.widget.Overlay</a> instance.</li>
            ...
            * <a href="pega.widget.Overlay.html">pega.widget.Overlay</a>.  
            * If the <a href="pega.widget.Menu.html#CSS_CLASS_NAME">
            * default CSS class name for pega.widget.Menu</a> is applied to 
            * the <code>&#60;div&#62;</code> element, it will be created as an
            * instance of <a href="pega.widget.Menu.html">pega.widget.Menu
            ...
            * <a href="pega.widget.MenuItem.html">pega.widget.MenuItem</a> 
            * configuration attributes.</li>
            * <li>Array of strings representing the text labels for each menu 
            * item in the menu.</li>
            * </ul>
            * @type <a href="pega.widget.Menu.html">pega.widget.Menu</a>|<a 
            * href="pega.widget.Overlay.html">pega.widget.Overlay</a>|<a 
            ...
            * <a href="pega.widget.Menu.html#lazyLoad">"lazyload"</a>
            ...
            * <a href="pega.widget.Menu.html">pega.widget.Menu</a> or 
            * <a href="pega.widget.Overlay.html">pega.widget.Overlay</a> 
            * instance is passed as the value of the button's "menu" 
            * configuration attribute. <a href="pega.widget.Menu.html">
            * pega.widget.Menu</a> or <a href="pega.widget.Overlay.html">
            * pega.widget.Overlay</a> instances should be rendered before 
        ...
        * @return {<a href="pega.widget.Overlay.html">
        * pega.widget.Overlay</a>|<a 
        * href="pega.widget.Menu.html">pega.widget.Menu</a>}
        */
        getMenu: function () {
        ...
        */
        destroy: function () {
            ...
            Event.purgeElement(oElement,true);
            Event.purgeElement(this._button,true);
            Event.removeListener(document, "mouseup", this._onDocumentMouseUp);
            Event.removeListener(document, "keyup", this._onDocumentKeyUp);
            Event.removeListener(document, "mousedown", 
                this._onDocumentMouseDown);
            ...
            if (Lang.isArray(aButtons) && aButtons.length === 0) {
                ...
                Event.removeListener(oForm, "keypress", 
                        pega.widget.Button.onFormKeyPress);
        ...
        fireEvent: function (p_sType , p_aArgs) {
			...
			return pega.widget.Button.superclass.fireEvent.apply(this, arguments);
    ...
    /**
    * @method pega.widget.Button.onFormKeyPress
    * @description "keypress" event handler for the button's form.
    * @param {Event} p_oEvent Object representing the DOM event object passed 
    * back by the event utility (pega.util.Event).
    */
    pega.widget.Button.onFormKeyPress = function (p_oEvent) {
    ...
    /**
    * @method pega.widget.Button.addHiddenFieldsToForm
    * @description Searches the specified form and adds hidden fields for  
    * instances of pega.widget.Button that are of type "radio," "checkbox," 
    * "menu," and "split."
    * @param {<a href="http://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level-
    * one-html.html#ID-40002357">HTMLFormElement</a>} p_oForm Object reference 
    * for the form to search.
    */
    pega.widget.Button.addHiddenFieldsToForm = function (p_oForm) {
    
        var aButtons = Dom.getElementsByClassName(
                            pega.widget.Button.prototype.CSS_CLASS_NAME, 
                            "*", 
                            p_oForm),
    ...
    /**
    * @method pega.widget.Button.getButton
    ...
    * @return {pega.widget.Button}
    */
    pega.widget.Button.getButton = function (p_sId) {
    ...
    * the event utility (pega.util.Event) when the event was fired.  See 
    * <a href="pega.util.Element.html#addListener">Element.addListener</a> 
    ...
    * the event utility (pega.util.Event) when the event was fired.  See 
    * <a href="pega.util.Element.html#addListener">Element.addListener</a> for  
...
(function () {
    ...
    * @extends pega.util.Element
    */
    pega.widget.ButtonGroup = function (p_oElement, p_oAttributes) {
    
        var fnSuperClass = pega.widget.ButtonGroup.superclass.constructor,
            sNodeName,
            oElement,
            sId;
    ...
    pega.extend(pega.widget.ButtonGroup, pega.util.Element, {
        ...
        * @protected
        * @param {Event} p_oEvent Object representing the event that was fired.
        * @param {<a href="pega.widget.Button.html">pega.widget.Button</a>}  
        ...
        */
        init: function (p_oElement, p_oAttributes) {
            ...
            pega.widget.ButtonGroup.superclass.init.call(this, p_oElement, 
                    p_oAttributes);
        ...
        */
        initAttributes: function (p_oAttributes) {
            ...
            pega.widget.ButtonGroup.superclass.initAttributes.call(
                this, oAttributes);
            ...
            * is checked.
            * @type {<a href="pega.widget.Button.html">pega.widget.Button</a>}
            * @default null
            */
        ...
        * @param {<a href="pega.widget.Button.html">pega.widget.Button</a>}  
        * p_oButton Object reference for the <a href="pega.widget.Button.html">
        * pega.widget.Button</a> instance to be added to the button group.
        ...
        * <a href="pega.widget.Button.html">pega.widget.Button</a> 
        * configuration attributes used to configure the button to be added to 
        * the button group.
        * @return {<a href="pega.widget.Button.html">pega.widget.Button</a>} 
        */
        ...
        * @param {Array} p_aButtons Array of <a href="pega.widget.Button.html">
        * pega.widget.Button</a> instances to be added 
        * to the button group.
        ...
        * a set of <a href="pega.widget.Button.html">pega.widget.Button</a>  
...
pega.register("button", pega.widget.Button, {version: "2.5.2", build: "1076"});