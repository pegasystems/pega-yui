                ...
                case 'opacity' :// IE opacity uses filter
                    ...
                    try { // will error if no DXImageTransform
                        ...
                        try { // make sure its in the document
                            ...
                            pega.log('getStyle: IE filter failed',
                                    'error', 'Dom');
                        }
                    }
                    return val / 100;
    ...
    pega.util.Dom = {
        ...
        setStyle: function(el, property, val) {
            ...
            var f = function(element) {
                ...
                pega.log('setStyle setting ' + property + ' to ' + val, 'info', 'Dom');
        ...
        getXY: function(el) {
            var f = function(el) {
                ...
                if ( (el.parentNode === null || el.offsetParent === null ||
                    ...
                    pega.log('getXY failed: element not available', 'error', 'Dom');
                    return false;
                }
                
                pega.log('getXY returning ' + getXY(el), 'info', 'Dom');
                return getXY(el);
            };
        ...
        setXY: function(el, pos, noRetry) {
            var f = function(el) {
                ...
                if (pageXY === false) { // has to be part of doc to have pageXY
                    pega.log('setXY failed: element not available', 'error', 'Dom');
                    return false; 
                }
                ...
                pega.log('setXY setting position to ' + pos, 'info', 'Dom');
            };
        ...
        getRegion: function(el) {
            var f = function(el) {
                if ( (el.parentNode === null || el.offsetParent === null ||
                        this.getStyle(el, 'display') == 'none') && el != el.ownerDocument.body) {
                    pega.log('getRegion failed: element not available', 'error', 'Dom');
                    return false;
                }

                var region = Y.Region.getRegion(el);
                pega.log('getRegion returning ' + region, 'info', 'Dom');
                return region;
            };
        ...
        hasClass: function(el, className) {
            ...
            var f = function(el) {
                pega.log('hasClass returning ' + re.test(el.className), 'info', 'Dom');
        ...
        addClass: function(el, className) {
            var f = function(el) {
                ...
                pega.log('addClass adding ' + className, 'info', 'Dom');
        ...
        removeClass: function(el, className) {
            ...
            var f = function(el) {
                ...
                pega.log('removeClass removing ' + className, 'info', 'Dom');
        ...
        replaceClass: function(el, oldClassName, newClassName) {
            ...
            var f = function(el) {
                pega.log('replaceClass replacing ' + oldClassName + ' with ' + newClassName, 'info', 'Dom');
        ...
        generateId: function(el, prefix) {
            ...
            var f = function(el) {
                if (el && el.id) { // do not override existing ID
                    pega.log('generateId returning existing id ' + el.id, 'info', 'Dom');
                    return el.id;
                } 

                var id = prefix + pega.env._id_counter++;
                pega.log('generateId generating ' + id, 'info', 'Dom');
        ...
        isAncestor: function(haystack, needle) {
            ...
            if (haystack.contains && needle.nodeType && !isSafari) { // safari contains is broken
                pega.log('isAncestor returning ' + haystack.contains(needle), 'info', 'Dom');
                return haystack.contains(needle);
            }
            else if ( haystack.compareDocumentPosition && needle.nodeType ) {
                pega.log('isAncestor returning ' + !!(haystack.compareDocumentPosition(needle) & 16), 'info', 'Dom');
            ...
            pega.log('isAncestor failed; most likely needle is not an HTMLElement', 'error', 'Dom');
            return false;
        },
        ...
        getElementsBy: function(method, tag, root, apply) {
            ...
            pega.log('getElementsBy returning ' + nodes, 'info', 'Dom');
        ...
        batch: function(el, method, o, override) {
            ...
            if (!el || !method) {
                pega.log('batch failed: invalid arguments', 'error', 'Dom');
                return false;
            } 
        ...
        getDocumentHeight: function() {
            ...
            pega.log('getDocumentHeight returning ' + h, 'info', 'Dom');
            return h;
        },
        ...
        getDocumentWidth: function() {
            ...
            pega.log('getDocumentWidth returning ' + w, 'info', 'Dom');
            return w;
        },
        ...
        getViewportHeight: function() {
            ...
            pega.log('getViewportHeight returning ' + height, 'info', 'Dom');
            return height;
        },
        ...
        getViewportWidth: function() {
            ...
            pega.log('getViewportWidth returning ' + width, 'info', 'Dom');
            return width;
        },
       ...
       /**
        ...
        getAncestorBy: function(node, method) {
            while (node = node.parentNode) { // NOTE: assignment
                if ( testElement(node, method) ) {
                    pega.log('getAncestorBy returning ' + node, 'info', 'Dom');
                    return node;
                }
            } 

            pega.log('getAncestorBy returning null (no ancestor passed test)', 'error', 'Dom');
            return null;
        },
        ...
        getAncestorByClassName: function(node, className) {
            node = Y.Dom.get(node);
            if (!node) {
                pega.log('getAncestorByClassName failed: invalid node argument', 'error', 'Dom');
                return null;
            }
        ...
        getAncestorByTagName: function(node, tagName) {
            node = Y.Dom.get(node);
            if (!node) {
                pega.log('getAncestorByTagName failed: invalid node argument', 'error', 'Dom');
                return null;
            }
        ...
        getPreviousSibling: function(node) {
            node = Y.Dom.get(node);
            if (!node) {
                pega.log('getPreviousSibling failed: invalid node argument', 'error', 'Dom');
                return null;
            }
        ...
        getNextSibling: function(node) {
            node = Y.Dom.get(node);
            if (!node) {
                pega.log('getNextSibling failed: invalid node argument', 'error', 'Dom');
                return null;
            }
        ...
        getFirstChild: function(node, method) {
            node = Y.Dom.get(node);
            if (!node) {
                pega.log('getFirstChild failed: invalid node argument', 'error', 'Dom');
                return null;
            }
        ...
        getLastChildBy: function(node, method) {
            if (!node) {
                pega.log('getLastChild failed: invalid node argument', 'error', 'Dom');
                return null;
            }
        ...
        getChildren: function(node) {
            node = Y.Dom.get(node);
            if (!node) {
                pega.log('getChildren failed: invalid node argument', 'error', 'Dom');
            }
        ...
        insertBefore: function(newNode, referenceNode) {
            ...
            if (!newNode || !referenceNode || !referenceNode.parentNode) {
                pega.log('insertAfter failed: missing or invalid arg(s)', 'error', 'Dom');
                return null;
            }       
