 ...
 *                  will receive. pega.util.CustomEvent.LIST or 
...
pega.util.CustomEvent = function(type, oScope, silent, signature) {
    ...
    if (!this.silent) {
        pega.log( "Creating " + this, "info", "Event" );
    }
...
throw new Error("Invalid callback for subscriber to '" + this.type + "'");
    ...
    fire: function() {
        ...
        for (i=0; i<len; ++i) {
            var s = subs[i];
            if (!s) {
                //pega.log('DEBUG rebuilding array');
                rebuild=true;
            } else {
                if (!this.silent) {
pega.log( this.type + "->" + (i+1) + ": " +  s, "info", "Event" );
                }
                ...
                if (this.signature == pega.util.CustomEvent.FLAT) {
                    ...
                    try {
                        ...
                        this.lastError = e;
pega.log(this + " subscriber exception: " + e, "error", "Event");
                    }
                } else {
                    try {
                        ...
                        this.lastError = ex;
pega.log(this + " subscriber exception: " + ex, "error", "Event");
                    }
                }
                if (false === ret) {
                    if (!this.silent) {
pega.log("Event stopped, sub " + i + " of " + len, "info", "Event");
                    }
	...
	*/
	/**
            ...
            addListener: function(el, sType, fn, obj, override) {
                ...
                if (!fn || !fn.call) {
pega.log(sType + " addListener failed, invalid callback", "error", "Event");
                    return false;
                }
            ...
            _isValidCollection: function(o) {
                try {
                    ...
                    pega.log("node access error (xframe?)", "warn");
                    return false;
                }
...
pega.util.EventProvider.prototype = {
    ...
    createEvent: function(p_type, p_config) {
        ...
        if (events[p_type]) {
pega.log("EventProvider createEvent skipped: '"+p_type+"' already exists");
        } else {
   ...
   /**
    ...
    fireEvent: function(p_type, arg1, arg2, etc) {
        ...
        if (!ce) {
pega.log(p_type + "event fired before it was created.");
            return null;
        }
...
pega.util.KeyListener = function(attachTo, keyData, handler, event) {
    if (!attachTo) {
        pega.log("No attachTo element specified", "error");
    } else if (!keyData) {
        pega.log("No keyData specified", "error");
    } else if (!handler) {
        pega.log("No handler specified", "error");
    } 
