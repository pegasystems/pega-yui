...
(function () {
    ...
    pega.lang.augmentProto(Slider, pega.util.EventProvider);
    
    pega.widget.Slider = Slider;
    })();
    /**
     ...
     * should move a certain number pixels at a time.
     */
    pega.widget.SliderThumb = function(id, sGroup, iLeft, iRight, iUp, iDown, iTickSize) {
    
        if (id) {
            pega.widget.SliderThumb.superclass.constructor.call(this, id, sGroup);
    ...
    pega.extend(pega.widget.SliderThumb, pega.util.DD, {
        ...
        getOffsetFromParent0: function(parentPos) {
            var myPos = pega.util.Dom.getXY(this.getEl()),
                ppos  = parentPos || pega.util.Dom.getXY(this.parentElId);
        ...
        getOffsetFromParent: function(parentPos) {
            ...
            if (!this.deltaOffset) {
                ...
                myPos = pega.util.Dom.getXY(el);
                ppos  = parentPos || pega.util.Dom.getXY(this.parentElId);
    
                newOffset = [ (myPos[0] - ppos[0]), (myPos[1] - ppos[1]) ];
    
                l = parseInt( pega.util.Dom.getStyle(el, "left"), 10 );
                t = parseInt( pega.util.Dom.getStyle(el, "top" ), 10 );
                ...
                newLeft = parseInt( pega.util.Dom.getStyle(el, "left"), 10 );
                newTop  = parseInt( pega.util.Dom.getStyle(el, "top" ), 10 );
         ...
         */
        clearTicks: function () {
            pega.widget.SliderThumb.superclass.clearTicks.call(this);
            this.tickSize = 0;
        ...
        getXValue: function () {
            ...
            if (pega.lang.isNumber(newOffset[0])) {
        ...
        getYValue: function () {
            ...
            var newOffset = this.getOffsetFromParent();
            if (pega.lang.isNumber(newOffset[1])) {
                this.lastOffset = newOffset;
        ...
        /**
         * The onchange event for the handle/thumb is delegated to the pega.widget.Slider
    ...
    function DualSlider(minSlider, maxSlider, range, initVals) {
        ...
        initVals = pega.lang.isArray(initVals) ? initVals : [0,range];
    ...
    pega.lang.augmentProto(DualSlider, pega.util.EventProvider);
    
    
    /**
     * Factory method for creating a horizontal dual-thumb slider
     * @for pega.widget.Slider
     * @method pega.widget.Slider.getHorizDualSlider
     * @static
     ...
     * @for pega.widget.Slider
     * @method pega.widget.Slider.getVertDualSlider
     * @static
     * @param {String} bg the id of the slider's background element
     * @param {String} minthumb the id of the min thumb
     * @param {String} maxthumb the id of the thumb thumb
    ...
    pega.widget.DualSlider = DualSlider;
    
    })();
    pega.register("slider", pega.widget.Slider, {version: "2.8.2r1", build: "7"});