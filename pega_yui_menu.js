...
* @default pega.widget.MenuItem
* @final
* @type pega.widget.MenuItem
*/
ITEM_TYPE: null,
...
init: function (p_oElement, p_oConfig) {
    ...
    if (!this.ITEM_TYPE) {
        ...
        this.ITEM_TYPE = pega.widget.MenuItem;
...
* item belongs.
* @param {pega.widget.MenuItem} p_oItem Object reference for the MenuItem 
...
_onVisibleChange: function (p_sType, p_aArgs) {
    ...
    if (bVisible) {
        ...
        var that = this;
        this._tmpResizeCallback = function(){that._handleWindowResize();};
...
* @description Hides visible menus on resize
* @private
*/
_handleWindowResize: function(){
    MenuManager.hideVisible();
},
/**
...
_execHideDelay: function () {
    ...
    function hideMenu() {
        ...
        if (oRoot == me && !(me instanceof pega.widget.MenuBar) && 
...
* @private
* @param {pega.widget.Menu} p_oMenu Object specifying the menu that should 
* be made visible.
*/
...
* @private
* @param {pega.widget.Menu} p_oSubmenu Object specifying the submenu that  
* should be hidden.
        ...
        if (!oItem.handledMouseOutEvent && ((oRelatedTarget != oItem.element &&  
            ...
            if (!bMovingToSubmenu) {
                ...
                if (oSubmenu) {
                    ...
                    if (!(this instanceof pega.widget.MenuBar) && 
                        nSubmenuHideDelay > 0 && 
...
* @param {pega.widget.Menu} p_oMenu Object representing the menu that 
* fired the event.
*/
			...
			*/
			...
			if (!oSubmenu) {
				...
				*/
				...
				if (oRoot instanceof pega.widget.MenuBar || 
        ...
        switch(oEvent.keyCode) {
            ...
            case 37:    // Left arrow
                ...
                if (oParentItem) {
                    ...
                    if (oParentMenu instanceof pega.widget.MenuBar) {
...
_onBeforeShow: function (p_sType, p_aArgs) {
    ...
    if (!(this instanceof pega.widget.MenuBar) && bDynamicPos) {
        ...
        if (nMaxHeight === 0) {
            ...
            if (this.parent && 
                this.parent.parent instanceof pega.widget.MenuBar) {
               
                oRegion = pega.util.Region.getRegion(this.parent.element);
...
_onShow: function (p_sType, p_aArgs) {
    ...
    if (oParent) {
        ...
        if (!oParentMenu.cfg.getProperty("autosubmenudisplay") && 
            (oParentMenu instanceof pega.widget.MenuBar || 
...
* was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {pega.widget.Menu} p_oSubmenu Object representing the submenu that 
...
* that was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {pega.widget.MenuItem} p_oItem Object representing the menu item 
...
enforceConstraints: function (type, args, obj) {
	...
	pega.widget.Menu.superclass.enforceConstraints.apply(this, arguments);
...
* @param {Array} p_aArgs Collection of arguments sent when the event 
* was fired.
* @param {pega.widget.Menu} p_oMenu The Menu instance fired
* the event.
*/
...
* @param {pega.widget.Menu} p_oMenu The Menu instance fired the event.
*/
...
onRender: function (p_sType, p_aArgs) {
    ...
    function sizeShadow() {
        ...
        if (oShadow && oElement) {
			...
			if (parseInt(oShadow.style.width) && parseInt(oShadow.style.height)) {
...
* @param {pega.widget.MenuItem} p_oObject Object reference for the MenuItem 
...
removeItem: function (p_oObject, p_nGroupIndex) {
    ...
    if (typeof p_oObject != "undefined") {
        ...
        if (p_oObject instanceof pega.widget.MenuItem) {
...
* @constructor
*/
pega.widget.MenuItem = function (p_oObject, p_oConfig) {
...
MenuItem.prototype = {
    ...
    */    
    configSelected: function (p_sType, p_aArgs, p_oItem) {
        ...
        if (this.hasFocus() && pega.env.ua.opera) {
        ...
        */
        ...
        if (!this._oOnclickAttributeValue && typeof oObject == "object" && 
            ...
            this.clickEvent.subscribe(oObject.fn, 
                ((!pega.lang.isUndefined(oObject.obj)) ? oObject.obj : this), 
                oObject.scope);
	...
	*/
	initDefaultConfig : function () {
        ...
        * [<a href="pega.widget.Menu.html#itemData">array of values for 
    ...
    focus: function () {
        ...
        function setFocus() {
            ...
            try {
                ...
                if (pega.env.ua.ie && !document.hasFocus()) {
    ...
    */
    hasFocus: function () {
        ...
        return (pega.widget.MenuManager.getFocusedMenuItem() == this);
...
Lang.augmentProto(MenuItem, pega.util.EventProvider);
...
* @class ContextMenu
* @constructor
* @extends pega.widget.Menu
* @namespace pega.widget
*/
pega.widget.ContextMenu = function(p_oElement, p_oConfig) {

    pega.widget.ContextMenu.superclass.constructor.call(this, 
...
var Event = pega.util.Event,
    ContextMenu = pega.widget.ContextMenu,
    ...
    */
    EVENT_TYPES = {
        ...
        "CONTEXT_MENU": (pega.env.ua.opera ? "mousedown" : "contextmenu"),
        "CLICK": "click"
...
pega.lang.extend(ContextMenu, pega.widget.Menu, {
...
init: function(p_oElement, p_oConfig) {
    ...
    // Call the init of the superclass (pega.widget.Menu)
...
initEvents: function() {
    ...
    this.triggerContextMenuEvent.signature = pega.util.CustomEvent.LIST;
...
* by the event utility (pega.util.Event).
* @param {pega.widget.ContextMenu} p_oMenu Object representing the context 
...
_onTriggerContextMenu: function(p_oEvent, p_oMenu) {
    ...
    */
    ...
    if(!this._bCancelled) {
        ...
        if (!pega.util.Dom.inDocument(this.element)) {
...
* @constructor
* @extends pega.widget.MenuItem
* @deprecated As of version 2.4.0 items for pega.widget.ContextMenu instances
* are of type pega.widget.MenuItem.
*/
pega.widget.ContextMenuItem = pega.widget.MenuItem;
(function () {
...
* @namespace pega.widget
*/
pega.widget.MenuBar = function(p_oElement, p_oConfig) {

    pega.widget.MenuBar.superclass.constructor.call(this, 
        p_oElement, p_oConfig);
...
pega.lang.extend(MenuBar, pega.widget.Menu, {
...
init: function(p_oElement, p_oConfig) {
    ...
    if(!this.ITEM_TYPE) {
        ...
        this.ITEM_TYPE = pega.widget.MenuBarItem;
...
* was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {pega.widget.MenuBar} p_oMenuBar Object representing the menu bar 
* that fired the event.
*/
...
* @extends pega.widget.MenuItem
*/
pega.widget.MenuBarItem = function(p_oObject, p_oConfig) {

    pega.widget.MenuBarItem.superclass.constructor.call(this, 
        p_oObject, p_oConfig);

};

pega.lang.extend(pega.widget.MenuBarItem, pega.widget.MenuItem, {
...
init: function(p_oObject, p_oConfig) {
    ...
    if(!this.SUBMENU_TYPE) {
        ...
        this.SUBMENU_TYPE = pega.widget.Menu;

    }


    /* 
        Call the init of the superclass (pega.widget.MenuItem)
        Note: We don't pass the user config in here yet 
        because we only want it executed once, at the lowest 
        subclass level.
    */ 

    pega.widget.MenuBarItem.superclass.init.call(this, p_oObject);  
...
pega.register("menu", pega.widget.Menu, {version: "2.5.2", build: "1076"});