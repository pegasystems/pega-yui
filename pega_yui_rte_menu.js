    ...
    pega.widget.MenuManager = function () {
        ...
        */
        function onItemAdded(p_sType, p_aArgs) {
            ...
            if (oItem instanceof pega.widget.MenuItemNew) { 
        ...
        return {
            ...
            * be retrieved.
            * @return {pega.widget.MenuItemNew}
            */
...
* @default pega.widget.MenuItemNew
* @final
* @type pega.widget.MenuItemNew
*/
ITEM_TYPE: null,
...
init: function (p_oElement, p_oConfig) {
    ...
    if (!this.ITEM_TYPE) {
        ...
        this.ITEM_TYPE = pega.widget.MenuItemNew;
...
* item belongs.
* @param {pega.widget.MenuItemNew} p_oItem Object reference for the MenuItem 
...
* that was fired.
* @param {Array} p_aArgs Array of arguments sent when the event was fired.
* @param {pega.widget.MenuItemNew} p_oItem Object representing the menu item 
...
* @param {pega.widget.MenuItemNew} p_oObject Object reference for the MenuItem 
...
removeItem: function (p_oObject, p_nGroupIndex) {
    ...
    if (typeof p_oObject != "undefined") {
        ...
        if (p_oObject instanceof pega.widget.MenuItemNew) {
...
* @constructor
*/
pega.widget.MenuItemNew = function (p_oObject, p_oConfig) {
    if (p_oObject) {
...
var Dom = pega.util.Dom,
    Module = pega.widget.Module,
    Menu = pega.widget.Menu,
    MenuItem = pega.widget.MenuItemNew,
    CustomEvent = pega.util.CustomEvent,
    Lang = pega.lang,
...
* @constructor
* @extends pega.widget.MenuItemNew
* @deprecated As of version 2.4.0 items for pega.widget.ContextMenu instances
* are of type pega.widget.MenuItemNew.
*/
pega.widget.ContextMenuItem = pega.widget.MenuItemNew;
(function () {
...
pega.lang.extend(pega.widget.MenuBarItem, pega.widget.MenuItemNew, {
...
init: function(p_oObject, p_oConfig) {
    ...
    /* 
        Call the init of the superclass (pega.widget.MenuItemNew)
        Note: We don't pass the user config in here yet 
        because we only want it executed once, at the lowest 
        subclass level.
    */ 
