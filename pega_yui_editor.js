...
/* }}} */
                ...
                method: function(draggable) {
                    if (draggable && !this.get('titlebar')) {
                        if (!this._dragHandle) {
                            ...
                            * @type Object
                            */
                            this.dd = new pega.util.DD(this.get('id'));
        ...
        */
        addButton: function(oButton, after) {
            ...
            if (_oButton.menu) {
                if ((pega.widget.Overlay) && (oButton.menu instanceof pega.widget.Overlay)) {
            ...
            if (skip) {
                ...
                if (tmp._button.tagName.toLowerCase() == 'button') {
                    ...
                    pega.util.Event.purgeElement(tmp._button,true);
                    tmp._button.innerHTML = "";
                ...
                if(pega.u.d.fieldValuesList.get(tmp.get('label'))) label = pega.u.d.fieldValuesList.get(tmp.get('label')).replace("/","");
                tmp.get('element').setAttribute('title', label);
                if (oButton.type != 'spin') {
                    if ((pega.widget.Overlay) && (_oButton.menu instanceof pega.widget.Overlay)) {
                        ...
                        if (tmp.getMenu().mouseDownEvent) {
                            tmp.getMenu().mouseDownEvent.subscribe(function(ev, args) {
                                var oMenu = args[1];
                                pega.util.Event.stopEvent(args[0]);
        ...
        */
        addSeparator: function(cont, after) {
            ...
            return _sep;
		        ...
		        /**
        * @method appendColorPicker
        * @private
        * @description Used in _createColorPicker api to register the load event
        */
		appendColorPicker:function(){
        ...
        */
        _createColorPicker: function(id) {
			...
			Event.on(window, 'load',this.appendColorPicker, this, true);
        ...
        * @param {Object} _oButton <a href="pega.widget.ToolbarButton.html">pega.widget.ToolbarButton</a> reference
        */
        _makeColorButton: function(_oButton) {
            ...
            _oButton.type = 'color';
            _oButton.menu = new pega.widget.Overlay(this.get('id') + '_' + _oButton.value + '_menu', { visible: false, position: 'absolute', iframe: true });
        ...
        * @param {Object} _button <a href="pega.widget.ToolbarButton.html">pega.widget.ToolbarButton</a> reference
        ...
        */
        _makeSpinButton: function(_button, oButton) {
            ...
            _b1.className = 'up';
            var label = this.STR_SPIN_UP;

            if(pega.u.d.fieldValuesList.get('STR_SPIN_UP')) label = pega.u.d.fieldValuesList.get('STR_SPIN_UP').replace("/","");
            _b1.title = label;
            _b1.innerHTML = label;
            _b2.className = 'down';
            var label = this.STR_SPIN_DOWN;
            if(pega.u.d.fieldValuesList.get('STR_SPIN_DOWN')) label = pega.u.d.fieldValuesList.get('STR_SPIN_DOWN').replace("/","");
            _b2.title = label;
            _b2.innerHTML = label;
			...
			if(pega.u.d.fieldValuesList.get('STR_SPIN_LABEL1') && pega.u.d.fieldValuesList.get('STR_SPIN_LABEL2')){																	
        		this.STR_SPIN_LABEL=pega.u.d.fieldValuesList.get('STR_SPIN_LABEL1').replace("/","")+' {VALUE}'+pega.u.d.fieldValuesList.get('STR_SPIN_LABEL2').replace("/","");
			}
            var label = pega.lang.substitute(this.STR_SPIN_LABEL, { VALUE: _button.get('label') });
            ...
            var _intUp = function(ev) {
                ...
                if (!_button.get('disabled') && (ev.keyCode != 9)) {
                    ...
                    var label = pega.lang.substitute(strLabel, { VALUE: _button.get('label') });
                    _button.set('title', label);
                    if (!br.webkit && tbar) {
        ...
        * @return {<a href="pega.widget.ToolbarButton.html">pega.widget.ToolbarButton</a>}
        */
        ...
        * @return {<a href="pega.widget.ToolbarButton.html">pega.widget.ToolbarButton</a> or <a href="pega.widget.MenuItem.html">pega.widget.MenuItem</a>}
        */
        ...
        */
        ...
        this._buttonList[i].destroy();
        this._buttonList[i]=null;
      }
       pega.util.Event.purgeElement(this.get('element'),true)    ;
            this.get('element').innerHTML = '';
            this.get('element').className = '';

       var par = this.get('element').parentNode;
       par.removeChild(this.get('element'));
...
* @description Fires when any botton receives a click event. Passes back a single object representing the buttons config object. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
...
* of the button config. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* Example:
* <code><pre>
* buttons : [
...
* @description Fires when the toolbar is expanded via the collapse button. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event toolbarCollapsed
* @description Fires when the toolbar is collapsed via the collapse button. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
})();
/**
...
var Dom = pega.util.Dom,
    ...
    */
    ...
    pega.widget.SimpleEditor = function(el, attrs) {
        this.rteElts = false;
        ...
        var element_cont = null;
        if(this.rteElts) {
            element_cont = this.rteElts._container;
        }
        else {
            element_cont = document.createElement('DIV');
        }
        oConfig.attributes.element_cont = new pega.util.Element(element_cont, {
            id: id + '_container'
        });
        var div = null;

        if(this.rteElts) {
            div = this.rteElts._firstChild;
        }
        else {
        ...
        if (!oConfig.attributes.toolbar_cont) {
            ...
            if(this.rteElts && this.rteElts._toolbar) {
                tbDiv = this.rteElts._toolbar;
            }
            else {
                tbDiv = document.createElement('DIV');
                div.appendChild(tbDiv);
            }
            oConfig.attributes.toolbar_cont = tbDiv;
            oConfig.attributes.toolbar_cont.id = id + '_toolbar';
        }

        var editorWrapper = null;
        if(this.rteElts) {
            editorWrapper = this.rteElts._wrapper;
        }
        else {
        ...
        pega.widget.SimpleEditor.superclass.constructor.call(this, oConfig.element, oConfig.attributes);
    };



    pega.extend(pega.widget.SimpleEditor, pega.util.Element, {
        /**
        * @property _docType
        ...
        * @description The default CSS used in the config for 'css'. This way you can add to the config like this: { css: pega.widget.SimpleEditor.prototype._defaultCSS + 'ADD MYY CSS HERE' }
        * @type String
        */
        ...
        */
        ...
        /**
        * @property toolbar
        * @description Local property containing the <a href="pega.widget.Toolbar.html">pega.widget.Toolbar</a> instance
        * @type <a href="pega.widget.Toolbar.html">pega.widget.Toolbar</a>
        */
        toolbar: null,
        /**
        * @private
        ...
        */
        _createIframe: function() {
            ...
            var ifrm = new pega.util.Element(ifrmDom);
        ...
        */
        _selectNode: function(node,endLength) {
            if (!node) {
                return false;
            }
            var sel = this._getSelection(),
            ...
            if (this.browser.ie) {
                try { //IE freaks out here sometimes..
                    ...
                    range.moveToElementText(node.length > 0 ? node[0] : node);
					if (endLength) {
						range.moveEnd("character", endLength);
					}
                    range.select();
                } catch (e) {
                }
	   ...
	   Dom.initializingEditor = true;
           ...
           /*BUG-111029: The modal with old RTE wasn't setting the width correctly*/
        ...
        */
		...
		try{
			var errorDiv=pega.util.Dom.getElementsById(this._configs.textarea.value.name+"Error",this.rteElts._container.parentNode.parentNode,"DIV");
            var titleString = this._configs.textarea.value.getAttribute("rteTitle")
			if(errorDiv.length>0){
			this.STR_TITLE+=pega.util.Dom.getFirstChild(errorDiv[0]).title;
			if(titleString){
			this._configs.textarea.value.setAttribute("rteTitle",titleString+pega.util.Dom.getFirstChild(errorDiv[0]).title);
			}
			this.on('editorContentLoaded',function(){
				this._getDoc().body.accessKey = "e";
				});
			}
		}
		catch(e){}
                ...
                var html = Lang.substitute(this.get('html'), {
                    TITLE: this._configs.textarea.value.getAttribute("rteTitle") ? this._configs.textarea.value.getAttribute("rteTitle") : this.STR_TITLE,
                    ...
                    LINKS: ((this.get('links')) ? this.get('links') : '')
                }),
                check = true;
        ...
        */
        _getSelectedElement: function(flag) {
            ...
            if (this.browser.ie) {
                ...
                if (range) {
					if(!range.item) {
						var tempParent = range.parentElement();
						if(flag == 'checkLI') {
							while(tempParent.tagName.toLowerCase() != 'body') {
								if(tempParent.tagName.toLowerCase() != 'li') {
							...
							var htmlText = range.htmlText.toLowerCase();
							if(htmlText.lastIndexOf('<br>') == htmlText.length -4){
                ...
                if ((this.currentEvent !== null) && (this.currentEvent.keyCode === 0) && elm == null) {
            ...
            if (this.browser.opera || this.browser.webkit) {
                if (this.currentEvent && !elm) {
                    elm = pega.util.Event.getTarget(this.currentEvent);
                }
            }
            if (!elm || !elm.tagName) {
                elm = doc.body;
        ...
        */
        _fixNodes: function() {
            ...
            for (var v in this.invalidHTML) {
                if (pega.lang.hasOwnProperty(this.invalidHTML, v)) {
        ...
        */
        _handleClick: function(ev) {
            ...
            if (this.browser.ie) {
                this._cleanSpans(this._getDoc().body);
            }
            this._setCurrentEvent(ev);
            if (this.currentWindow) {
                this.closeWindow();
            }
            if (pega.widget.EditorInfo.window.win && pega.widget.EditorInfo.window.scope) {
                pega.widget.EditorInfo.window.scope.closeWindow.call(pega.widget.EditorInfo.window.scope);
            }
        ...
        */
		...
		this.handleEmptyRow(this._getDoc());
                case 8: //Delete
        ...
        _handleKeyDown: function(ev) {
            ...
            switch (ev.keyCode) {
                case 84: //Focus Toolbar Header -- Ctrl + Shift + T
                    ...
                    break;
                case 27: //Focus After Element - Esc
                ...
                case 9:
                    if(pega.u.d.isAccessible){
                        if (ev.shiftKey) {
         			        this.beforeElement.focus();
        			        pega.util.Event.stopEvent(ev);
        			        doExec = false;
        			        focusElementFromRTE(this.beforeElement, true);
        		        } else {
        			        this.afterElement.focus();
        			        pega.util.Event.stopEvent(ev); 
        			        doExec = false;
        			        focusElementFromRTE(this.afterElement, false);
        		        }
                    }
                    else{
                        if (this.browser.ie) {
                ...
                case 13:
                    if (this.browser.ie) {
                        ...
                        _range = this._getRange();
                        tar = this._getSelectedElement('checkLI');
                        if (!this._isElement(tar, 'li')) {
                            if (_range) {
                                _range.pasteHTML('<br>');
                                _range.collapse(false);
	   ...
	   var temp = ""+this.toolbar.getButtonByValue('fontsize')+"";
	   var fontsize = temp.replace("Button ","");
	   temp = ""+this.toolbar.getButtonByValue('fontname')+"";
	   var fontname=temp.replace("Button ","");
	   temp = ""+this.toolbar.getButtonByValue('forecolor')+"";
	   var forecolor=temp.replace("Button ","");
	   temp = ""+this.toolbar.getButtonByValue('backcolor')+"";
	   var backcolor=temp.replace("Button ","");
	...
	this.toolbar.enableButton(forecolor);
           ...
           this.toolbar.disableButton(fontname);
           this.toolbar.disableButton(fontsize);
	  this.toolbar.disableButton(forecolor);
           this.toolbar.disableButton(backcolor);
	}
        ...
        * @param {<a href="pega.widget.Toolbar.html">pega.widget.Toolbar</a>} The Toolbar instance the button belongs to (defaults to this.toolbar)
        ...
        */
        _setupAfterElement: function() {
            if (!this.beforeElement) {
				...
				if(this.get('element_cont').get('firstChild').nodeType !== 3) {
					this.get('element_cont').get('firstChild').insertBefore(this.beforeElement, this.toolbar.get('nextSibling'));
				} else if(this.get('element_cont').get('firstChild').nextSibling.nodeType !== 3) {
					this.get('element_cont').get('firstChild').nextSibling.insertBefore(this.beforeElement, this.toolbar.get('nextSibling'));
				} else {
            ...
            if (!this.afterElement) {
				...
				if(this.get('element_cont').get('firstChild').nodeType !== 3) {
					...
					this.get('element_cont').get('firstChild').nextSibling.appendChild(this.afterElement);
				} else {
					this.afterElement = null;
				}
            }
        ...
        */
        init: function(p_oElement, p_oAttributes) {
                ...
                this._defaultToolbar = {
                    ...
                    buttons: [
                        { group: 'fontstyle', label: 'Font Name and Size',
                            buttons: [
                                { type: 'select', label: pega.u.d.fieldValuesList.get('Arial'), value: 'fontname', disabled: true,
                                    menu: [
                                        { text: pega.u.d.fieldValuesList.get('Arial'), checked: true },
                                        { text: pega.u.d.fieldValuesList.get('Arial Black') },
                                        { text: pega.u.d.fieldValuesList.get('Comic Sans MS') },
                                        { text: pega.u.d.fieldValuesList.get('Courier New') },
                                        { text: pega.u.d.fieldValuesList.get('Lucida Console') },
                                        { text: pega.u.d.fieldValuesList.get('Tahoma') },
                                        { text: pega.u.d.fieldValuesList.get('Times New Roman') },
                                        { text: pega.u.d.fieldValuesList.get('Trebuchet MS') },
                                        { text: pega.u.d.fieldValuesList.get('Verdana') }
                                    ]
                                },
                        ...
                        { group: 'textstyle', label: 'Font Style',
                            buttons: [
                                { type: 'push', label: pega.u.d.fieldValuesList.get('Bold CTRL + SHIFT + B'), value: 'bold' },
                                { type: 'push', label: pega.u.d.fieldValuesList.get('Italic CTRL + SHIFT + I'), value: 'italic' },
                                { type: 'push', label: pega.u.d.fieldValuesList.get('Underline CTRL + SHIFT + U'), value: 'underline' },
                                { type: 'separator' },
                                { type: 'color', label: pega.u.d.fieldValuesList.get('Font Color'), value: 'forecolor', disabled: true },
                                { type: 'color', label: pega.u.d.fieldValuesList.get("Background Color"), value: 'backcolor', disabled: true }
                        ...
                        { group: 'indentlist', label: 'Lists',
                            buttons: [
                                { type: 'push', label: pega.u.d.fieldValuesList.get('Create an Unordered List'), value: 'insertunorderedlist' },
                                { type: 'push', label: pega.u.d.fieldValuesList.get('Create an Ordered List'), value: 'insertorderedlist' }
                            ]
                        },
                        { type: 'separator' },
            ...
            pega.widget.SimpleEditor.superclass.init.call(this, p_oElement, p_oAttributes);
            pega.widget.EditorInfo._instances[this.get('id')] = this;
        ...
        */
        initAttributes: function(attr) {
            pega.widget.SimpleEditor.superclass.initAttributes.call(this, attr);
            var self = this;
            ...
            this.setAttributeConfig('height', {
                ...
                method: function(height) {
                    if (this._rendered) {
                        ...
                        if (this.get('animate')) {
                            var anim = new pega.util.Anim(this.get('iframe').get('parentNode'), {
                                height: {
            ...
            this.setAttributeConfig('width', {
                ...
                method: function(width) {
                    if (this._rendered) {
                        ...
                        if (this.get('animate')) {
                            var anim = new pega.util.Anim(this.get('element_cont').get('element'), {
                                width: {
            ...
            * @default This HTML requires a few things if you are to override:
                <p><code>{TITLE}, {CSS}, {HIDDEN_CSS}, {EXTRA_CSS}</code> and <code>{CONTENT}</code> need to be there, they are passed to pega.lang.substitute to be replace with other strings.<p>
            ...
            */
            this.setAttributeConfig('html', {
                value: attr.html || '<html><head><title>{TITLE}</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><base href="' + this._baseHREF + '"><style>{CSS}</style><style>{HIDDEN_CSS}</style>{LINKS}<style>{EXTRA_CSS}</style></head><body id="RTEcontentbody" style="overflow: auto; line-height:normal" onload="document.body._rteLoaded = true;">{CONTENT}</body></html>',
                writeOnce: true
            });
            ...
            */
            ...
            /**
            * @attribute links
            * @description Extra user defined link tags
            * @default ''
            * @type String
            */
            ...
            */
            this.setAttributeConfig('animate', {
                value: ((attr.animate) ? ((pega.util.Anim) ? true : false) : false),
                validator: function(value) {
                    var ret = true;
                    if (!pega.util.Anim) {
                        ret = false;
        ...
        */
        _getBlankImage: function() {
            ...
            if (!this._blankImageLoaded) {
                if (pega.widget.EditorInfo.blankImage) {
                    this.set('blankimage', pega.widget.EditorInfo.blankImage);
                    ...
                    img = pega.util.Dom.getStyle(div, 'background-image');
                    img = img.replace('url(', '').replace(')', '').replace(/"/g, '');
                    //Adobe AIR Code
                    img = img.replace('app:/', '');
                    this.set('blankimage', img);
                    this._blankImageLoaded = true;
                    pega.widget.EditorInfo.blankImage = img;
                }
            } else {
        ...
        */
        _handleFormSubmit: function(ev) {
            ...
            window.setTimeout(function() {
                pega.util.Event.removeListener(form, 'submit', self._handleFormSubmit);
                if (pega.env.ua.ie) {
                    ...
                    if (tar && !tar.disabled) {
                        ...
                        if (pega.env.ua.webkit) {
                            if (pega.lang.isFunction(form.submit)) {
                                form.submit();
                            }
                        }
                    }
	   ...
	   //Added for change#14
            ...
            for (var i = 0; i < path.length; i++) {
                ...
                if (Dom.getStyle(elm, 'font-family')) {
                    ...
                    //Adobe AIR Code
                    //BUG-153496: When we have quotations we need to remove it for checking it properly with predefined Fonts
            ...
            var styleArray = null;
            if(this.browser.ie){
                styleArray = this._findStyle(elm);
            }
            if(styleArray != null && styleArray[1] != '') {
                family = styleArray[1];
            }
            ...
            if (fs_button) {
				fontsize = null;
                if(styleArray != null && styleArray[0] != '') {
                    fontsize = styleArray[0];
                }
                ...
                var label = pega.lang.substitute(this.toolbar.STR_SPIN_LABEL, { VALUE: fs_button.get('label') });
                fs_button.set('title', label);
            }
        ...
        _cleanSpans: function(elm) {
            if(elm == null || elm.firstChild == null) {
                return;
            }

            for(var j=0;j<elm.childNodes.length;j++) {
                if(elm.childNodes[j] != null) {
                    this._cleanSpans(elm.childNodes[j]);
                }
            }

            if(elm.childNodes.length == 1 || (elm.childNodes.length == 2 && (elm.lastChild && elm.lastChild.nodeName=="#text"))) {
                if(elm.tagName == 'SPAN' && elm.firstChild.tagName == 'SPAN') {
                    var styleArray = ['fontSize', 'fontFamily', 'backgroundColor', 'color'];
                    var styleLen = styleArray.length;
                    var oNewChild = null;
                    var styleType = '';
                    var tempChild = elm.firstChild;
                    for(var i=0;i<styleLen;i++) {
                        if(elm.style[styleArray[i]] != '' && tempChild.style[styleArray[i]] != '') {
                            styleType = styleArray[i];
                            break;
                        }
                    }

                    if(styleType != '') {
                        var sInnerHTML = tempChild.innerHTML;
                        var oNewChild = this._getDoc().createElement('span');
                        oNewChild.style.cssText = elm.style.cssText + ";" + tempChild.style.cssText;
                        oNewChild.tag = 'span';
                        oNewChild.className = 'yui-tag-span yui-tag';
                        elm.parentElement.replaceChild(oNewChild, elm);
        ...
        _findStyle: function(elm ) {
            ...
            if(elm.tagName == 'SPAN' && this._getRange().text.indexOf(elm.innerText) != -1) {
                styleArray = new Array();
                styleArray[styleArray.length] = parseInt(elm.style['fontSize'],10);
                styleArray[styleArray.length] = elm.style['fontFamily'];
            }


		for(var j=0;j<elm.childNodes.length;j++) {
			if(elm.childNodes[j] != null) {
                   tempArray = this._findStyle(elm.childNodes[j]);
                    if(tempArray != null) {
                        if(!isNaN(tempArray[0])){
                            if(styleArray == null) {
                                styleArray = new Array();
                            }
                            styleArray[0] = tempArray[0];
                        }
                        if(tempArray[1] != '') {
                            styleArray[1] = tempArray[1];
                        }
                    }
                }
            }
	...
	handleEmptyRow : function(doc) {
		var tableTags = doc.getElementsByTagName('table');
		for(var i=0; i<tableTags.length;i++) {
			var tableElem = tableTags[i];
			tBodyElem = tableElem.tBodies[0];
			var rowNos = new Array();
			var preNode = null;
			for(var j=0;j<tBodyElem.rows.length;j++) {
				var currRow = tBodyElem.rows[j];
				var count = 0;
				for(var l=0;l<currRow.cells.length;l++) {
					var currCell = currRow.cells[l];
					if(currCell.innerHTML == "") count++;
				}
				if(count == currRow.cells.length) {					
					rowNos.push(j);
					if(preNode != null) {
						preNode.innerHTML = preNode.innerHTML + '<br>';
					}
				} else {
					preNode = tBodyElem.rows[j].cells[0];
				}
			}
			
			for(var k=rowNos.length;k>0;k--) {
				tableElem.deleteRow(tBodyElem.rows[rowNos[k-1]].rowIndex);
			}
		}
	},
        ...
        */
        _render: function() {
            ...
            if(!this.rteElts) {
                ...
                this.get('element_cont').setStyle('visibility', 'visible');
            }
		...
		window.setTimeout(function() {
		    ...
		    if (!this.beforeElement) {
		        this.beforeElement = pega.util.Dom.getNextSibling(this.toolbar._configs.element.value)
		    }
		    if (!this.afterElement) {
		        this.afterElement = pega.util.Dom.getLastChild(pega.util.Dom.getFirstChild(this.get("element_cont")._configs.element.value))
		    }
		}
    ...
    /* {{{  Command Overrides */
            ...
            if (!this._isElement(el, 'body') && !this._hasSelection()) {
                ...
                if (this.get('insert')) {
                    ...
                    if (this.browser.ie) {
                        ...
                        this._createCurrentElement('span', { color: el.style.color, fontSize: el.style.fontSize, fontFamily: el.style.fontFamily, backgroundColor: value });
                    }

                    if(this._hasSelection()) {
                        this._getRange().select();
                    } else {
            ...
            if (this._isElement(el, 'img')) {
                ...
                if (this._getDoc().queryCommandEnabled(action)) {
                    ...
                    for (var i = 0; i < imgs.length; i++) {
                        if (!pega.util.Dom.hasClass(imgs[i], 'yui-img')) {
                            pega.util.Dom.addClass(imgs[i], 'yui-img');
                    ...
                    if (el == this._getDoc().body) {
                        ...
                        pega.util.Dom.addClass(_img, 'yui-img');
        ...
        */
            ...
            */
            if ((this.browser.webkit && !this.browser.webkit4) || (this.browser.opera)) {
                if (this._isElement(selEl, 'li') && this._isElement(selEl.parentNode, tag)) {
                    ...
                    pega.util.Dom.addClass(list, 'yui-non');
                    str = '';
		     ...
		     //bug-85118 : substring code was there, but was not getting assigned to a str variable
		     str = str.substring(0, str.lastIndexOf('<br>'));		//Remove last line feed added.
                        var newEl = this._getDoc().createElement('span');
		      newEl.id = 'listWrapper';
                        newEl.innerHTML = str;
                ...
                if (this.browser.ie && exec) {
                    var html = '';
                    var t = '';
                    var listStartTag = '<li id="editorList">';
                    if (this._getRange().html) {
                        html = listStartTag + this._getRange().html+ '</li>';
                    } else {
                        /*var t = this._getRange().text.split('\n'); */
                        /*Kesha - We donot want to remove formatting, do we!!. split the htmlText with <br>, not the text with \n    */
		      //modified below code for hfix-6442 (msword is appending <o:p></o:p> as line breaks instead of br tag.	

                         /*if(this._getRange().htmlText.indexOf('<BR>') >= 0){
                            t = this._getRange().htmlText.split('<BR>');
		        */
			...
			html = html.replace(/<\/P>/gi,'<\/span><BR>');
			html = html.replace(/&nbsp;/g,"");
			html = html.replace(/\r\n/gi, "");
                        	if(html.lastIndexOf('<BR>') == html.length - 4) {
				html = html.substring(0, html.length - 4);
			}	
			var patt=new RegExp('<span id=[\'\"]*listWrapper[\"\']*>(.*)<\/span>', 'gi');
			while(true) {
				var result=html .match(patt);
				if(result == null) break;
				html = html.replace(patt, RegExp.$1);
			}

			var bMakeList = true;			
			if(html.match(new RegExp('<\/li>', 'gi')) != null) {
				bMakeList = false;
				//html = html.replace(new RegExp('<li id=[\'\"]?editorList[\'\"]?>', 'gi'), "");
				html = html.replace(new RegExp('<(?:LI|li|Li)[^>]*?>', 'gi'), "");
				html = html.replace(new RegExp('<\/li>', 'gi'), "<BR>");
			}

			patt = new RegExp('<(?:ul|ol) id=[\'\"]?editorList[\'\"]?>(.*)<\/(?:ul|ol)>', 'gi');
			while(true) {
				var result=html .match(patt);
				if(result == null) break;
				html = html.replace(patt, RegExp.$1);
			}			
			if(html.indexOf('<BR>') >= 0 && bMakeList){
				t = html.split('<BR>');

			//-hfix-6618

                            if (t.length > 1) {
                                var startSpanRegEx = new RegExp("<[^P][ \\s]*[\\w -:\'\"\\d=#\\s]*>", "gi");
                                var endSpanRegEx = new RegExp("</[^P]>", "gi");
                                var spanArray = new Array();
                                var spanStr = '';
                                var startSpanArr = null;
                                var endSpanArr = null;
                                var i = 0;
                                html = '';
                                for (var ie = 0; ie < t.length; ie++) {
                                    spanStr = '';
                     /* For BUG-25489 - a <P> at the beginning of a sentence disturbs the alignment during display */
                                    t[ie] = t[ie].replace(/<P>/gi, '');
                                    t[ie] = t[ie].replace(/<\/P>/gi, '');    //Similarly, end P must be removed from last list item
                                    t[ie] = t[ie].replace(/[\n\r]*/gi, '');
                                    startSpanArr = t[ie].match(startSpanRegEx);
                                    endSpanArr = t[ie].match(endSpanRegEx);
                                    if(startSpanArr != null && startSpanArr.length > 0) {
                                        if(endSpanArr != null && endSpanArr.length > 0) {
                                            var lenDiff = startSpanArr.length - endSpanArr.length;
                                            i = lenDiff;
                                            ...
                                            if(lenDiff > 0) {
                                                ...
                                                html += listStartTag + spanArray.join("") + t[ie];
                                                html += this._returnCloseTag(startSpanArr, lenDiff) + this._returnCloseTag(spanArray, spanArray.length) + '</li>';
                                            } else {
                                                while(i++ != 0) {
                                                    spanStr += spanArray.pop();
                                                }
                                                html += listStartTag + spanStr + t[ie] + '</li>';
                                            }
                                        } else {
                                            html += listStartTag + spanArray.join("") + t[ie];
                                            spanArray = spanArray.concat(startSpanArr);
                                            if(ie != t.length-1){    //Last element already has end tags
                                                html += this._returnCloseTag(spanArray, spanArray.length) + '</li>';
                                            }else{
                                                html += '</li>';
                                            }
                                        }
                                    } else if(endSpanArr != null && endSpanArr.length > 0) {
                                        i = spanArray.length - endSpanArr.length;
                                        html += listStartTag + spanArray.join("") + t[ie] + this._returnCloseTag(spanArray, i) + '</li>';
                                        while(i++ < endSpanArr.length) {
                                            spanArray.pop();
                                        }
                                    } else {
                                        i = spanArray.length;
                                ...
                                if (txt === '') {
                                    ...
                                    html = listStartTag + txt + '</li>';
                                }
                            }
                        } else{
                            /*If the html doesn't have a <BR>, meaning an ordered list is being converted to unordered list or vice-versa*/
                            //html = this._getRange().htmlText;    
                            html = html.replace(/<UL>|<\/UL>|<OL>|<\/OL>/gi, '');
			//bug-85118 : comparing string against both '<li id="editorList">' and '<LI id="editorList">' to ensure	
                            //if(html.indexOf(listStartTag) == -1 && html.indexOf(listStartTag) == -1) {
			if(!(html.indexOf(listStartTag) >= 0 || html.indexOf('<LI id="editorList">') >=0  || html.indexOf('<LI id=editorList>') >=0)) {	
                                html = html.replace(/<p>|<\/p>/gi, '');
                                if(html === '') {
                                    html = '<li id="new_list_item">' + html + '</li>';
                                } else {
				if(bMakeList)
                                    		html = listStartTag + html + '</li>';
                                }
                            }
                        }
                    }
                    //Remove all the nested ul and ol tags from the html to maintain uniformity
                    html = html.replace(/<UL.*>|<\/UL>|<OL.*>|<\/OL>/gi, '');
		if(bMakeList)
                    html = '<' + tag + ' id="editorList">' + html + '</' + tag + '>';
                    // This weird line fixes 2 problem. 1. Removes the unwanted nesting 2. doesn't include the junk character at the end
                    this._getRange().pasteHTML(''); 
        ...
        _returnCloseTag: function(arr, count) {
            if(arr == null) return;
            var len = arr.length;
            var closeTagString='';
            var tagRegEx = /^<([\w]+)/ig;
            for(var i=1;i<=count;i++){
                if(arr[len-i]){
					arr[len-i].match(tagRegEx);
					if(RegExp.$1 != ''){
					closeTagString += '</' + RegExp.$1 +'>';
					}
				}
	        }
        ...
        */
	    ...
	    var this1 = this;  	
            if (selEl && selEl.tagName && !this._hasSelection() && !this._isElement(selEl, 'body') && !this.get('insert')) {
                pega.util.Dom.setStyle(selEl, 'font-family', value);
                exec = false;
            } else if (this.get('insert') && !this._hasSelection()) {
                var el = this._createInsertElement({ fontFamily: value });
                exec = false;
            }      else if(this.browser.ie) {
                this._createCurrentElement('span', {'fontFamily': value });
                window.setTimeout( function() {

			if (this1.currentElement.length > 0) {
				var charLength = 0;
				for (var i=0; i<this1.currentElement.length ; i++) {
					charLength+= this1.currentElement[i].innerText.length;
				}
				this1._selectNode(this1.currentElement, charLength);       
			}
			else{
				this1._selectNode(this1.currentElement);       

			}
            try{
                        var sel = this1._getSelection(),
                        range = this1._getRange(),
                        el = this1._getSelectedElement(),
                        fn_button = this1.toolbar.getButtonByValue('fontname'),
                        fs_button = this1.toolbar.getButtonByValue('fontsize');

                        
                        //Handle updating the toolbar with active buttons
                        var _ex = {};
                        if (this1._lastButton) {
                               _ex[this1._lastButton.id] = true;
                            }
                          if (!this1._isElement(el, 'body')) {
                         if (fn_button) {
                            _ex[fn_button.get('id')] = true;
                        }
                        if (fs_button) {
                    ...
                    this1.toolbar.resetAllButtons(_ex);
                    //Handle disabled buttons
                    for (var d = 0; d < this1._disabled.length; d++) {
                        var _button = this1.toolbar.getButtonByValue(this1._disabled[d]);
                        if (_button && _button.get) {
                            if (this1._lastButton && (_button.get('id') === this1._lastButton.id)) {
                                //Skip
                            } else {
                                if (!this1._hasSelection()) {
                                    switch (this1._disabled[d]) {
                                        case 'fontname':
                                        case 'fontsize':
                                            break;
                                        default:
                                            //No Selection - disable
                                            this1.toolbar.disableButton(_button);
                                    }
                                } else {
                                    if (!this1._alwaysDisabled[this1._disabled[d]]) {
                                        this1.toolbar.enableButton(_button);
                                    }
                                }
                                if (!this1._alwaysEnabled[this1._disabled[d]]) {
                                    this1.toolbar.deselectButton(_button);
                                }
                            }
                        }
                    }
        ...
        cmd_fontsize: function(value) {
            ...
            if (this.browser.webkit) {
                if (this.currentElement[0]) {
                    if (el == this.currentElement[0]) {
                        go = false;
                        pega.util.Dom.setStyle(el, 'fontSize', value);
                        this._selectNode(el);
                        this.currentElement[0] = el;
                    }
                }
            ...
            if (go) {
                if (!this._isElement(this._getSelectedElement(), 'body') && (!this._hasSelection())) {
                    ...
                    pega.util.Dom.setStyle(this.currentElement, 'fontSize', value);
                } else {
				...
				/* Change 16 - Start */
				if (this.browser.ie) {
					//this._cleanSpans(this._getDoc().body); This causes lose of selection
				}
				/* Change 16 - End */
            }
            return [false];
        ...
        _createCurrentElement: function(tagName, tagStyle) {
            ...
            var _elCreate = function() {
                ...
                switch (tagName) {
                    ...
                    default:
                        ...
                        pega.util.Dom.addClass(el, 'yui-tag-' + tagName);
                        pega.util.Dom.addClass(el, 'yui-tag');
                        el.setAttribute('tag', tagName);

                        for (var k in tagStyle) {
                            if (pega.lang.hasOwnProperty(tagStyle, k)) {
            ...
            if (!this._hasSelection()) {
                if (this._getDoc().queryCommandEnabled('insertimage')) {
                    ...
                    if (this.currentEvent) {
                        tar = pega.util.Event.getTarget(this.currentEvent);
                    } else {
                        //For Safari..
                ...
                for (var i = 0; i < _tmp.length; i++) {
                    if ((pega.util.Dom.getStyle(_tmp[i], 'font-family') == 'yui-tmp') || (_tmp[i].face && (_tmp[i].face == 'yui-tmp'))) {
                        el = _elCreate();
						if(this.browser.ie) {
							if(el.style['fontSize'] !='' || el.style['color'] != '' || el.style['fontFamily'] != '' || el.style['backgroundColor'] != '') {
								var spanTags = _tmp[i].getElementsByTagName('span');
								var iter;
								var spanLen = spanTags.length;
								for(iter=0;iter<spanLen;iter++) {
									if(el.style['fontSize'] !='' && spanTags[iter].style['fontSize'] != '') {
										spanTags[iter].style['fontSize'] = '';
									} else if(el.style['color'] != ''  && spanTags[iter].style['color'] != '') {
										spanTags[iter].style['color'] = '';
									} else if(el.style['fontFamily'] != ''  && spanTags[iter].style['fontFamily'] != '') {
										spanTags[iter].style['fontFamily'] = '';
									} else if(el.style['backgroundColor'] != '' && spanTags[iter].style['backgroundColor'] != '') {
										spanTags[iter].style['backgroundColor'] = '';
									}
								}
							}
						}
	...
	trim: function(stringToTrim) {
	   ...
	   //Remove code related to spellchecker.
	   html = pega.u.d.spellChecker.cleanUp(this._getDoc().body);
            ...
            html = pega.lang.trim(html);

            if (this.get('removeLineBreaks')) {
                html = html.replace(/\n/g, '').replace(/\r/g, '');
                html = html.replace(/  /gi, ' '); //Replace all double spaces and replace with a single
            }
            var pat = /href=['"][a-zA-Z0-9\-_:=%'\/"\?&\.\*! ]*%3C[a-zA-Z0-9\-_\.\$%:='\/"\s ]*%3E['"]/gi;
            var hrefArray = html.match(pat);
            var hrefLen = hrefArray == null ? 0 : hrefArray.length;
            for(var i=0; i<hrefLen; i++) {
                var decodedUrl = hrefArray[i];
                decodedUrl = decodedUrl.replace('%3C','<');
                decodedUrl = decodedUrl.replace('%3E','>');
                decodedUrl = decodedUrl.replace(/%20/g,' ');
                html = html.replace(hrefArray[i],decodedUrl);
            }
	...
	//Browsers sometimes add <p>..</p> tags around content from the design mode. These tags are undesirable as they cause empty spaces in the templates. Make the behavior consistent by removing these tags
	   //Start paragraph tag
	   if (html.substring(0, 3).toLowerCase() == '<p>')  {
                html = html.substring(3);
                //End paragraph tag
                if (html.substring(html.length - 4, html.length).toLowerCase() == '</p>')  {
                    html = html.substring(0, html.length - 4);
                }
            }
            for (var v in this.invalidHTML) {
	   ...
	   // FIXED ENG-1896 - This extra LI causes the list item glyph to appear before the nested OL/UL.
...
//            this.saveHTML();
            ...
            if(this.get('element_cont') && this.get('element_cont').get('parentNode'))
...
/**
* @event toolbarLoaded
* @description Event is fired during the render process directly after the Toolbar is loaded. Allowing you to attach events to the toolbar. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event cleanHTML
...
/**
* @event afterRender
* @description Event is fired after the render process finishes. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event editorContentLoaded
* @description Event is fired after the editor iframe's document fully loads and fires it's onload event. From here you can start injecting your own things into the document. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event editorMouseUp
* @param {Event} ev The DOM Event that occured
* @description Passed through HTML Event. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
...
* @description Event fires at the beginning of the nodeChange process. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event afterNodeChange
* @description Event fires at the end of the nodeChange process. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event beforeExecCommand
* @description Event fires at the beginning of the execCommand process. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event afterExecCommand
* @description Event fires at the end of the execCommand process. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
...
/**
    ...
    */
    pega.widget.EditorInfo = {
        ...
        * @type Object <a href="pega.widget.EditorWindow.html">pega.widget.EditorWindow</a>
        */
        window: {},
        /**
        * @private
        ...
        * @type Object <a href="pega.widget.Overlay.html">pega.widget.Overlay</a>
        */
        panel: null,
        /**
        ...
        * @return Object <a href="pega.widget.Editor.html">pega.widget.Editor</a>
        */
        getEditorById: function(id) {
            if (!pega.lang.isString(id)) {
...
var Dom = pega.util.Dom,
     ...
     * @constructor
     * @class Editor
     * @extends pega.widget.SimpleEditor
     * @param {String/HTMLElement} el The textarea element to turn into an editor.
     * @param {Object} attrs Object liternal containing configuration parameters.
    */

    pega.widget.Editor = function(el, attrs) {
        pega.widget.Editor.superclass.constructor.call(this, el, attrs);
    };

    pega.extend(pega.widget.Editor, pega.widget.SimpleEditor, {
        /**
        * @property STR_BEFORE_EDITOR
        * @description The accessibility string for the element before the iFrame
        * @type String
        ...
        */
        init: function(p_oElement, p_oAttributes) {
            ...
            pega.widget.Editor.superclass.init.call(this, p_oElement, p_oAttributes);
        ...
        */
        initAttributes: function(attr) {
            pega.widget.Editor.superclass.initAttributes.call(this, attr);
        ...
        */
        _fixNodes: function() {
            pega.widget.Editor.superclass._fixNodes.call(this);
            var url = '';
        ...
        */
        _handleKeyDown: function(ev) {
            pega.widget.Editor.superclass._handleKeyDown.call(this, ev);
            var doExec = false,
                action = null,
                exec = false;
        ...
        _handleCreateLinkClick: function() {
            ...
            this.on('afterExecCommand', function() {
                ...
                var win = new pega.widget.EditorWindow('createlink', {
                    width: '350px'
                });
                ...
                Event.onAvailable('createlink_url', function() {
                    window.setTimeout(function() {
                        try {
                            pega.util.Dom.get('createlink_url').focus();
                        } catch (e) {}
                    }, 50);
        ...
        _handleInsertImageClick: function() {
            ...
            this.on('afterExecCommand', function() {
                var el = this.currentElement[0],
                    ...
                    owidth = 0,
                    blankimage = false,
                    win = new pega.widget.EditorWindow('insertimage', {
                        width: '415px'
                    });
                ...
                var tbar = new pega.widget.Toolbar(tbarCont, {
                    /* {{{ */
                ...
                Event.onAvailable('insertimage_url', function() {
                    ...
                    window.setTimeout(function() {
                        pega.util.Dom.get('insertimage_url').focus();
                        if (blankimage) {
                            pega.util.Dom.get('insertimage_url').select();
                        }
                    }, 50);
                            ...
                            if (this._isLocalFile(url.value)) {
                                ...
                                if (url && url.value && (url.value != this.STR_IMAGE_HERE)) {
                                    ...
                                    img.onerror = function() {
                                        ...
                                        pega.util.Dom.get('insertimage_height').value = img.height;
                                        pega.util.Dom.get('insertimage_width').value = img.width;
                                    };
                                    window.setTimeout(function() {
                                        pega.util.Dom.get('insertimage_height').value = img.height;
                                        pega.util.Dom.get('insertimage_width').value = img.width;
        ...
        * @return {<a href="pega.widget.Overlay.html">pega.widget.Overlay</a>}
        */
        _renderPanel: function() {
            var panel = null;
            if (!pega.widget.EditorInfo.panel) {
                panel = new pega.widget.Overlay(this.EDITOR_PANEL_ID, {
                    width: '300px',
                    iframe: true,
                    visible: false,
                    underlay: 'none',
                ...
                pega.widget.EditorInfo.panel = panel;
            } else {
                panel = pega.widget.EditorInfo.panel;
            }
            ...
            this.get('panel').showEvent.subscribe(function() {
                pega.util.Dom.setStyle(this.element, 'display', 'block');
            });
            return this.get('panel');
        },
        /**
        * @method openWindow
        * @param {<a href="pega.widget.EditorWindow.html">pega.widget.EditorWindow</a>} win A <a href="pega.widget.EditorWindow.html">pega.widget.EditorWindow</a> instance
        ...
        */
        openWindow: function(win) {
            ...
            pega.widget.EditorInfo.window.win = win;
            pega.widget.EditorInfo.window.scope = this;
            ...
            Dom.addClass(body, ((pega.widget.Button && (this._defaultToolbar.buttonType == 'advanced')) ? 'good-button' : 'no-button'));
            ...
            if (((xDiff > 10) || (yDiff > 10)) || force) { //Only move the window if it's supposed to move more than 10px or force was passed (new window)
                ...
                if (force) {
                    ...
                    if (this.get('animate')) {
                        ...
                        anim = new pega.util.Anim(panel.element, {
                            opacity: {
                                from: 0,
                                to: 1
                            }
                        }, 0.1, pega.util.Easing.easeOut);
                    ...
                    if (this.get('animate')) {
                        anim = new pega.util.Anim(panel.element, {}, 0.5, pega.util.Easing.easeOut);
                        anim.attributes = {
                            top: {
                                to: newXY[1]
                            },
                        ...
                        var iframeAnim = new pega.util.Anim(panel.iframe, anim.attributes, 0.5, pega.util.Easing.easeOut);

                        var _knobAnim = new pega.util.Anim(_knob, {
                            left: {
                                to: _knobLeft
                            }
                        }, 0.6, pega.util.Easing.easeOut);
                        anim.animate();
                        iframeAnim.animate();
                        _knobAnim.animate();
                    } else {
        ...
        cmd_removeformat: function(value) {
            ...
            */
            if (this.browser.webkit && !this._getDoc().queryCommandEnabled('removeformat')) {
                ...
                /*
                this._createCurrentElement('span');
                pega.util.Dom.addClass(this.currentElement[0], 'yui-non');
                var re= /<\S[^><]*>/g;
            ...
            if (this.browser.webkit || this.browser.ie || this.browser.gecko) {
                ...
                if (this._isElement(selEl, 'blockquote')) {
                    ...
                    if (this._isElement(selEl.parentNode, 'blockquote')) {
                        ...
                        pega.util.Dom.addClass(_span, 'yui-non');
    ...
    */
    pega.widget.EditorWindow = function(name, attrs) {
        /**
        * @private
        * @property name
    ...
    pega.widget.EditorWindow.prototype = {
        /**
        * @private
        * @property _cache
...
* @param {<a href="pega.widget.EditorWindow.html">EditorWindow</a>} win The EditorWindow object
* @param {Overlay} panel The Overlay object that is used to create the window.
* @description Event fires before an Editor Window is opened. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
...
* @param {<a href="pega.widget.EditorWindow.html">EditorWindow</a>} win The EditorWindow object
* @param {Overlay} panel The Overlay object that is used to create the window.
* @description Event fires after an Editor Window is opened. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event closeWindow
* @param {<a href="pega.widget.EditorWindow.html">EditorWindow</a>} win The EditorWindow object
* @description Event fires after an Editor Window is closed. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
* @event windowCMDOpen
* @param {<a href="pega.widget.EditorWindow.html">EditorWindow</a>} win The EditorWindow object
* @param {Overlay} panel The Overlay object that is used to create the window.
* @description Dynamic event fired when an <a href="pega.widget.EditorWindow.html">EditorWindow</a> is opened.. The dynamic event is based on the name of the window. Example Window: createlink, opening this window would fire the windowcreatelinkOpen event. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/
/**
...
* @param {<a href="pega.widget.EditorWindow.html">EditorWindow</a>} win The EditorWindow object
* @param {Overlay} panel The Overlay object that is used to create the window.
* @description Dynamic event fired when an <a href="pega.widget.EditorWindow.html">EditorWindow</a> is closed.. The dynamic event is based on the name of the window. Example Window: createlink, opening this window would fire the windowcreatelinkClose event. See <a href="pega.util.Element.html#addListener">Element.addListener</a> for more information on listening for this event.
* @type pega.util.CustomEvent
*/

})();
pega.register("editor", pega.widget.Editor, {version: "2.5.2", build: "1076"});