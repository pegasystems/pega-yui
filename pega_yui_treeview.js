...
pega.widget.Node.prototype = {
    ...
    */
    ...
    getToggleLink: function() {
        return "pega.widget.TreeView.getNode(\'" + this.tree.id + "\'," + 
            this.index + ").toggle()";
    },
...
pega.augment(pega.widget.Node, pega.util.EventProvider);
 ...
 * @namespace pega.widget
 * @class TextNode
 * @extends pega.widget.Node
 * @constructor
 * @param oData {object} a string or object containing the data that will
 * be used to render this node
 * @param oParent {pega.widget.Node} this node's parent node
 * @param expanded {boolean} the initial expanded/collapsed state
 */
pega.widget.TextNode = function(oData, oParent, expanded) {
...
pega.extend(pega.widget.TextNode, pega.widget.Node, {
    ...
    textNodeParentChange: function() {
         ...
         *
         * @event labelClick
         * @for pega.widget.TreeView
         * @param {pega.widget.Node} node the node clicked
         */
    ...
    getNodeHtml: function() { 
        ...
        var getNode = 'pega.widget.TreeView.getNode(\'' +
...
/**
 * A custom pega.widget.Node that handles the unique nature of 
 * the virtual, presentationless root node.
 * @namespace pega.widget
 * @class RootNode
 * @extends pega.widget.Node
 * @param oTree {pega.widget.TreeView} The tree instance this node belongs to
 * @constructor
 */
pega.widget.RootNode = function(oTree) {
...
pega.extend(pega.widget.RootNode, pega.widget.Node, {
 ...
 * have an icon
 */
pega.widget.HTMLNode = function(oData, oParent, expanded, hasIcon) {
    if (oData) { 
        this.init(oData, oParent, expanded);
...
pega.extend(pega.widget.HTMLNode, pega.widget.Node, {
    ...
    getNodeHtml: function() { 
        ...
        if (this.hasIcon) {
            ...
            if (this.hasChildren(true)) {
                sb[sb.length] = ' onmouseover="this.className=';
                sb[sb.length] = 'pega.widget.TreeView.getNode(\'';
 ...
 * @constructor
 */
pega.widget.MenuNode = function(oData, oParent, expanded) {
	if (oData) { 
		this.init(oData, oParent, expanded);
		this.setUpLabel(oData);
	}
...
pega.extend(pega.widget.MenuNode, pega.widget.TextNode, {
...
pega.widget.TVAnim = function() {
    return {
         ...
         * @return {pega.util.Animation} the animation instance
         * @static
         */
        getAnim: function(type, el, callback) {
            if (pega.widget[type]) {
                return new pega.widget[type](el, callback);
            } else {
                return null;
            }
        },
 ...
 */
pega.widget.TVFadeIn = function(el, callback) {
    /**
...
pega.widget.TVFadeIn.prototype = {
    /**
    ...
    animate: function() {
        ...
        var dur = 0.4; 
        var a = new pega.util.Anim(this.el, {opacity: {from: 0.1, to: 1, unit:""}}, dur);
 ...
 * @param callback {Function} function to invoke when the animation is finished
 */
pega.widget.TVFadeOut = function(el, callback) {
    /**
     * The element to animate
     * @property el
     * @type HTMLElement
...
pega.widget.TVFadeOut.prototype = {
    /**
     * Performs the animation
     * @method animate
     */
    animate: function() {
        var tvanim = this;
        var dur = 0.4;
        var a = new pega.util.Anim(this.el, {opacity: {from: 1, to: 0.1, unit:""}}, dur);
        a.onComplete.subscribe( function() { tvanim.onComplete(); } );
        a.animate();
    },
...
pega.register("treeview", pega.widget.TreeView, {version: "2.2.2", build: "204"});
