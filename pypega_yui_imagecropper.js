 ...
 * @requires pega, dom, dragdrop, element, event, resize
 * @module imagecropper
 */
(function() {
    var Dom = pega.util.Dom,
        ...
        */ 
        ...
        pega.extend(Crop, pega.util.Element, {
            /**
            * @private
            * @property CSS_MAIN
            ...
            */
            _createResize: function() {
                ...
                this._resizeEl.className = pega.util.Resize.prototype.CSS_RESIZE;
                ...
                this._resize = new pega.util.Resize(this._resizeEl, {
                    knobHandles: true,
                    handles: 'all',
                    draggable: true,
            ...
            */
            _handleMouseOver: function(ev) {
                var evType = 'keydown';
                if (pega.env.ua.gecko || pega.env.ua.opera) {
                    evType = 'keypress';
                }
                if (!this._active) {
                    this._active = true;
            ...
            * @return {<a href="pega.widget.ImageCropper.html">pega.widget.ImageCropper</a>} The ImageCropper instance
            */
            reset: function() {
    ...
    */
    ...
    pega.register("imagecropper", pega.widget.ImageCropper, {version: "2.9.0", build: "2800"});
