 ...
 * @class pega.util.Color
 * @namespace pega.util
 */
pega.util.Color = function() {

    var ZERO     = "0",
        isArray  = pega.lang.isArray,
        isNumber = pega.lang.isNumber;
...
(function() {
    ...
    pega.extend(ColorPicker, pega.util.Element, {
    ...
    pega.widget.ColorPicker = ColorPicker;
})();
pega.register("colorpicker", pega.widget.ColorPicker, {version: "2.8.2r1", build: "7"});