...
pega.util.Get = function() {
    ...
    var _fail = function(id, msg) {
        pega.log("get failure: " + msg, "warn", "Get");
        var q = queues[id];
    ...
    var _finish = function(id) {
        pega.log("Finishing transaction " + id);
        var q = queues[id];
        q.finished = true;
    ...
    var _next = function(id, loaded) {
        pega.log("_next: " + id + ", loaded: " + loaded, "info", "Get");
        var q = queues[id];
        ...
        var url = q.url[0];
        pega.log("attempting to load " + url, "info", "Get");
        ...
        pega.log("Appending node: " + url, "info", "Get");
        ...
        if (ua.ie) {
            n.onreadystatechange = function() {
                ...
                if ("loaded" === rs || "complete" === rs) {
                    pega.log(id + " onload " + url, "info", "Get");
                    f(id, url);
                }
            };
            ...
            if (type === "script") {
                ...
                if (ua.webkit >= 420) {
                    ...
                    n.addEventListener("load", function() {
                        pega.log(id + " DOM2 onload " + url, "info", "Get");
                        f(id, url);
                    });
                ...
                // property that the utility can poll for.
                    ...
                    if (q.varName) {
                        ...
                        pega.log("Polling for " + q.varName[0]);
                            ...
                            for (i=0; i<l; i=i+1) {
                                ...
                                if (!w) {
                                    ...
                                    if (this.attempts++ > this.maxattempts) {
                                        ...
                                        pega.log(a[i] + " failed, retrying");
                                    }
                                    return;
                                }
                            }
                            
                            pega.log("Safari poll complete");
    ...
    return {
        ...
        _finalize: function(id) {
            pega.log(id + " finalized ", "info", "Get");
         ...
         * <pre>
         *      pega.util.Get.css(["http://yui.pegaapis.com/2.3.1/build/menu/assets/skins/sam/menu.css",
         *                          "http://yui.pegaapis.com/2.3.1/build/logger/assets/skins/sam/logger.css"]);
         * </pre>
         * @return {tId: string} an object containing info about the transaction
         */
