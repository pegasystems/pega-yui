...
pega.widget.DualSlider = function(minSlider, maxSlider, range, initVals) {
...
pega.widget.DualSlider.prototype = {
    ...
    _handleDrag: function(e) {
        pega.widget.Slider.prototype.onDrag.call(this.activeSlider, e);
    },
    ...
    _handleMouseDown: function(e) {
        if (!e._handled) {
            ...
            return pega.widget.Slider.prototype.onMouseDown.call(this.activeSlider, e);
        } else {
            return false;
        }
    },
    ...
    _handleMouseUp : function (e) {
        pega.widget.Slider.prototype.onMouseUp.apply(
...
pega.lang.augmentProto(pega.widget.DualSlider, pega.util.EventProvider);
 ...
 */
pega.widget.Slider.getHorizDualSlider = 
    function (bg, minthumb, maxthumb, range, iTickSize, initVals) {
        var mint = new pega.widget.SliderThumb(minthumb, bg, 0, range, 0, 0, iTickSize),
            maxt = new pega.widget.SliderThumb(maxthumb, bg, 0, range, 0, 0, iTickSize);

        return new pega.widget.DualSlider(
                    new pega.widget.Slider(bg, bg, mint, "horiz"),
                    new pega.widget.Slider(bg, bg, maxt, "horiz"),
                    range, initVals);
};
 ...
 */
pega.widget.Slider.getVertDualSlider = 
    function (bg, minthumb, maxthumb, range, iTickSize, initVals) {
        var mint = new pega.widget.SliderThumb(minthumb, bg, 0, 0, 0, range, iTickSize),
            maxt = new pega.widget.SliderThumb(maxthumb, bg, 0, 0, 0, range, iTickSize);

        return new pega.widget.DualSlider(
                    new pega.widget.Slider(bg, bg, mint, "vert"),
                    new pega.widget.Slider(bg, bg, maxt, "vert"),
                    range, initVals);
};
