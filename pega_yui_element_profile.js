...
pega.util.Element.prototype = {
    ...
    appendTo: function(parent, before) {
        ...
        if (!element) {
            pega.log('appendTo failed: element not available',
                    'error', 'Element');
            return false;
        }
        
        if (!parent) {
            pega.log('appendTo failed: parent not available',
                    'error', 'Element');
            return false;
        }
        ...
        pega.log(element + 'appended to ' + parent);
