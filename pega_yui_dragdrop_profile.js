    ...
    pega.log("Could not get the loc for " + oDD.id, "warn", "DragDropMgr");
            ...
            verifyEl: function(el) {
                try {
                    ...
                    pega.log("detected problem with an element", "info", "DragDropMgr");
                }
            ...
            getLocation: function(oDD) {
                if (! this.isTypeOfDD(oDD)) {
                    pega.log(oDD + " is not a DD obj", "info", "DragDropMgr");
                    return null;
                }
                ...
                if (!pos) {
                    pega.log("getXY failed", "info", "DragDropMgr");
                    return null;
                }
            ...
            isOverTarget: function(pt, oTarget, intersect, curRegion) {
                ...
                if (!loc || !this.useCache) {
                    pega.log("cache not populated", "info", "DragDropMgr");
                    loc = this.getLocation(oTarget);
                    this.locationCache[oTarget.id] = loc;
    
                    pega.log("cache: " + loc, "info", "DragDropMgr");
                }
    
                if (!loc) {
                    pega.log("could not get the location of the element", "info", "DragDropMgr");
                    return false;
                }
    
                //pega.log("loc: " + loc + ", pt: " + pt);
                ...
                if (!dc || (!intersect && !dc.constrainX && !dc.constrainY)) {
                    ...
                    //if (oTarget.cursorIsOver) {
                        //pega.log("over " + oTarget + ", " + loc + ", " + pt, "warn");
                    //}
             ...
             */
            unregAll: function() {
                pega.log("unregister all", "info", "DragDropMgr");
            ...
            getScroll: function () {
                ...
                if (dde && (dde.scrollTop || dde.scrollLeft)) {
                    ...
                    pega.log("could not get scroll property", "info", "DragDropMgr");
                }
                return { top: t, left: l };
            },
            ...
            moveToEl: function (moveEl, targetEl) {
                ...
                pega.log("moveToEl: " + aCoord, "info", "DragDropMgr");
            ...
            _addListeners: function() {
                ...
                if ( pega.util.Event && document ) {
                    ...
                    if (DDM._timeoutCount > 2000) {
                        pega.log("DragDrop requires the Event Utility", "error", "DragDropMgr");
                    } else {
            ...
            handleWasClicked: function(node, id) {
                if (this.isHandle(id, node.id)) {
                    pega.log("clicked node is a handle", "info", "DragDropMgr");
                    return true;
                } else {
                    ...
                    while (p) {
                        if (this.isHandle(id, p.id)) {
                            ...
                            pega.log(p.id + " is not a handle", "info", "DragDropMgr");
                            p = p.parentNode;
                        }
                    }
                }
    ...
    pega.util.DragDrop.prototype = {
        ...
        */
        ...
        initTarget: function(id, sGroup, config) {
            ...
            if (typeof id !== "string") {
                pega.log("id is not a string, assuming it is an HTMLElement");
                this._domRef = id;
            ...
            this.logger = (pega.widget.LogWriter) ? 
                    new pega.widget.LogWriter(this.toString()) : pega;
